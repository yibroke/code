...
class Mdl_menu_sub extends CI_Model {
    ...
    {
        $this->db->select('menu_sub.*,items.*');
        $this->db->from('menu_sub');
        $this->db->where('menu_sub.id',$id);
        $this->db->join('items','items.fk_menu_sub_id=menu_sub.id');
        $query=  $this->db->get();
        return $query->result();
    }
    ...
    function get_where_custom($col, $value) {
        ...
        $this->db->where('menu_sub.public','y');
