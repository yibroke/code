...
<h1><?php echo lang('list').' '.  lang('category'); ?></h1>
<a href="<?php echo base_url(); ?>category/insert"><button class="btn btn-success"><span class="glyphicon glyphicon-plus-sign"></span> <?php echo lang('add'); ?></button></a>
    <div id="myerror"></div>
    <table class="table">
        <thead>
            <tr>
